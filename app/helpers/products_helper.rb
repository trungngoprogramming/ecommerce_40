module ProductsHelper
  ...
  def average_rating product
    ...
    return if product.ratings.average(:rating).blank?
    product.ratings.average(:rating).round(Settings.product.rating.round)
  end

  def stocking product
    return true unless product.quantity_product_available == Settings.quantity.product.not_available
  end
end
